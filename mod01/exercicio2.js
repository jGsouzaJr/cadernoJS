...
const nome = 'walter white'
// let newName = nome[0].toLocaleUpperCase() + nome.slice(1,7)+ nome[7].toLocaleUpperCase() + nome.slice(8)
...
const newName = `${nome[0].toLocaleUpperCase()}${nome.slice(1,7)}${nome[7].toLocaleUpperCase()}${nome.slice(8)}`
