...
const foodsInfo = `Até aqui, o array 'brazilianFoods' possui ${brazilianFoods.length} itens: ${brazilianFoods.join(', ')}`;
...
const sobremesa = dessert.replace('n', 'd')
