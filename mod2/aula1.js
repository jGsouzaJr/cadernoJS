...
const my3FavoriteTVShows = ['Dexter', 'One Piece', 'Naruto']

const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(', ')}.`.replace(', N',' e N')
...
const numSen = typeSentence.length

console.log(`"A string que a "typeSentence" armazena tem mais de 39 caracteres? ${numSen >= 39}."`)
...
console.log(`A soma entre o 1º e o 3º item de "ages" é menor ou igual a ${p}. Essa afirmação  
é: ${agesSum <= p}."`)
...
console.log(`A const evenNumbers contém o número 8: ${evenNumbers.includes(8)}!`)